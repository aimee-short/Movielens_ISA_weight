...
def ISA_group_evaluation(f,t,k):
    t1 = time.time()
    ...
    # 创建预测评分矩阵
    work_fore = xlrd.open_workbook(r'/home/user_yao/Movielens/eva_%d/Movielens_isa_%d_%d_weight_forecast.xlsx'%(f,t,k),'rd')
    t_fk = work_fore.sheet_by_name('top-k')#最终top-n比对数据  0:User_ID  1:Count_forecast  2:Count_effec  3:Sorted_forecast

    workbook = xlsxwriter.Workbook(r'/home/user_yao/Movielens/eva_%d/Movielens_isa_%d_%d_weight_nDCG.xlsx'%(f,t,k))
