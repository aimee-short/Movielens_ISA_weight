...
def ISA_save(f,t,k):
    ...
    #是否曾经评过分
    #b_rating = xlrd.open_workbook('/home/user_yao/Filmtrust_array_train_242.xlsx','rb')
    ...
    data = sio.loadmat(r'/home/user_yao/Movielens/ISA_%d/%s.mat'%(f,name))

    # 创建聚类总体信息
    #workbook = xlsxwriter.Workbook('Filmtrust_isa_242_%d_sta.xlsx'%k)
    workbook = xlsxwriter.Workbook(r'/home/user_yao/Movielens/sta_%d/Movielens_isa_%d_%d_sta.xlsx'%(f,t,k))
    ...
    workgroup = xlsxwriter.Workbook(r'/home/user_yao/Movielens/sta_%d/Movielens_isa_%d_%d_all.xlsx'%(f,t,k))
